...
exports.DEFAULT_EVM_CHAIN = exports.EVM_CHAINS = void 0;
...
exports.DEFAULT_EVM_CHAIN = process.env.DEFAULT_EVM_CHAIN || 'u2uTestnet';
function getEVMChain(chainKey) {
    return exports.EVM_CHAINS[chainKey];
}
function getAllEVMChains() {
    return Object.values(exports.EVM_CHAINS);
}
function getTestnetChains() {
    return Object.values(exports.EVM_CHAINS).filter(chain => chain.isTestnet);
}
function getMainnetChains() {
    return Object.values(exports.EVM_CHAINS).filter(chain => !chain.isTestnet);
}
function getChainByChainId(chainId) {
    return Object.values(exports.EVM_CHAINS).find(chain => chain.chainId === chainId);
}
//# sourceMappingURL=evm.config.js.map