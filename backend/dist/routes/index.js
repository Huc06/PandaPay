...
const evm_wallet_routes_1 = __importDefault(require("./evm-wallet.routes"));
...
const u2u_contract_routes_1 = __importDefault(require("./u2u-contract.routes"));
...
router.use('/evm-wallet', evm_wallet_routes_1.default);
router.use('/card', card_routes_1.default);
router.use('/user', user_routes_1.default);
router.use('/merchant', merchant_routes_1.default);
router.use('/admin', admin_routes_1.default);
router.use('/u2u-contract', u2u_contract_routes_1.default);
